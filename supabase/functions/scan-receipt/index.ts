          ...
          tools: [
            {
              ...
              function: {
                ...
                description:
                  "Extrahiert strukturierte Daten aus einem Beleg/Quittung/Rechnung.",
                parameters: {
                  type: "object",
                  properties: {
                    document_type: {
                    ...
                    vendor_name: {
                      type: "string",
                      description:
                        "Name des Geschäfts/Lieferanten/Ausstellers",
                    },
                    total_amount: {
                      type: "number",
                      description:
                        "Gesamtbetrag in EUR (nur die Zahl, z.B. 49.99)",
                    },
                    tax_amount: {
                      type: "number",
                    ...
                    category: {
                      ...
                      description:
                        "Kategorie: material (Hufeisen, Nägel, Beschlag), treibstoff (Diesel, Benzin, Tankbelege), fortbildung (Kurse, Seminare), werkzeug (Raspel, Zangen, Amboss), sonstiges (alles andere)",
                    },
                    description: {
                      type: "string",
                      description:
                        "Kurze Beschreibung des Beleginhalts (max 100 Zeichen)",
                    },
                    line_items: {
                      type: "array",
                      items: {
                    ...
                    confidence: {
                      type: "number",
                      description:
                        "Konfidenz der Erkennung von 0 bis 1 (1 = sehr sicher)",
                    },
                  },
                  required: [
                    "document_type",

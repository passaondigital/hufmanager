...
-- Set app settings for the trigger (these need to be set via database configuration)
-- The trigger will use these to call the edge function

-- Update the notify function to work without settings (use hardcoded URL)
...
BEGIN
  ...
  -- Using the Supabase project URL directly

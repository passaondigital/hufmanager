...
export const helpTexts: Record<string, Record<string, HelpTextEntry>> = {
  ...
  tresor: {
    bereich: {
      title: "Tresor",
      description: "Der Tresor schützt deine wichtigsten Dokumente mit einer PIN. Kaufverträge, Versicherungen und der Equidenpass sind hier sicher aufbewahrt.",
    },
    postident: {
      title: "PostIdent",
      description: "PostIdent verifiziert deine Identität durch ein Video-Ident-Verfahren. Einmalig nötig für den Tresor-Zugang.",
    },
  },

  // ─── Team & Partner (Prompt 10) ──────────────────────────
  team: {
    bereich: {
      title: "Kompetenzteam",
      description: "Hier verwaltest du wer Zugriff auf die Daten deines Pferdes hat. Du entscheidest immer selbst.",
    },
    "team-freigabe": {
      title: "Team-Freigabe",
      description: "Wenn aktiv, können alle Teammitglieder untereinander relevante Befunde einsehen. Du kannst das jederzeit deaktivieren.",
    },
    "partner-empfehlen": {
      title: "Fachpartner empfehlen",
      description: "Empfehle dem Pferdebesitzer einen Fachpartner. Der Besitzer entscheidet ob er Zugriff gewährt.",
    },
  },

  // ─── Provider-spezifisch (Prompt 10) ─────────────────────
  provider: {
    "termine-heute": {
      title: "Termine heute",
      description: "Zeigt alle Termine für heute. Klicke auf einen Termin um Details zu sehen und die Bearbeitung zu starten.",
    },
    "akten-score": {
      title: "Akten-Score",
      description: "Der Akten-Score zeigt wie vollständig die Stammdaten dieses Pferdes sind. 100% = alle wichtigen Felder ausgefüllt.",
    },
    "hufi-voice": {
      title: "HufiAI Spracheingabe",
      description: "Sprich deinen Befund ins Mikrofon. HufiAI wandelt deine Sprachnotiz automatisch in einen strukturierten Befund um.",
    },
    "foto-vergleich": {
      title: "Foto-Vergleich",
      description: "Ziehe den Slider um zwischen Vorher- und Nachher-Foto zu wechseln. So siehst du den Fortschritt auf einen Blick.",
    },
    impfalarm: {
      title: "Impfalarm",
      description: "Dieses Pferd hat überfällige Impfungen. Bitte den Besitzer informieren.",
    },
    "aku-mappe": {
      title: "AKU-Mappe",
      description: "Die AKU-Mappe enthält den vollständigen Gesundheitsverlauf für eine Ankaufsuntersuchung. Tresor-Dokumente sind nicht enthalten.",
    },
  },

  // ─── Client-spezifisch (Prompt 10) ───────────────────────
  kunden: {
    pferdeakte: {
      title: "Pferdeakte",
    ...
    stallboard: {
      title: "Stallboard",
      description: "Kommuniziere mit anderen Stallbesitzern und teile Neuigkeiten rund um den Stall.",
    },
  },

  // ─── Partner-spezifisch (Prompt 10) ──────────────────────
  partner: {
    "sichtbar-provider": {
    ...
    rechnungen: {
      title: "Rechnungen",
      description: "Verwalte deine Rechnungen an Pferdebesitzer. Rechnungen können als PDF heruntergeladen werden.",
    },
    chat: {
      title: "Chat",
      description: "Kommuniziere direkt mit Pferdebesitzern und anderen Dienstleistern.",
    },
  },
};

  ...
  return (
    <div className="space-y-5">
      ...
      <button
        ...
        className="fixed above-bottom-nav right-6 z-fab h-14 w-14 rounded-full bg-primary text-primary-foreground shadow-lg flex items-center justify-center hover:bg-primary/90 transition-colors md:hidden"

...
export default function PartnerManagementKommunikation() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Vorlagen & Benachrichtigungen</p>
      </div>
      <PartnerSettings tabs={["notifications"]} hideChrome />
    </div>
  );
}

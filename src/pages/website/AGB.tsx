    ...
    <main className="container py-24 md:py-32">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-white/60 mb-10 leading-relaxed">
          für die Erbringung von Dienstleistungen von Barhufserviceschmid, Emsdettener Str. 10, c/o Postflex #10643, 48268 Greven, E-Mail: support@hufiapp.de (nachfolgend „Auftragnehmer") gegenüber seinen Kunden (nachfolgend „Auftraggeber")
        </p>

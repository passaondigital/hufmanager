        ...
        <section className="space-y-8 text-white/70 [&_h2]:text-white [&_h3]:text-white [&_h4]:text-white">
          ...
          <div>
            ...
            <p className="mb-4">
              ...
              <a href="mailto:support@hufiapp.de" className="text-primary hover:underline">support@hufiapp.de</a><br />
              Telefon: 015209007017<br />
              E-Mail: <a href="mailto:support@hufiapp.de" className="text-primary hover:underline">support@hufiapp.de</a>
            </p>

...
const CookieBanner = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-toast p-4 md:p-6 animate-fade-in">
      <div className="max-w-4xl mx-auto bg-zinc-900 border border-white/10 rounded-2xl p-6 shadow-2xl">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
          ...
          <div className="flex gap-3 w-full md:w-auto">
            <Button variant="outline" onClick={() => { localStorage.setItem("huf_cookie_consent", "essential"); setIsVisible(false); }} className="flex-1 md:flex-none bg-transparent border-white/20 text-white hover:bg-white/10">Nur notwendige</Button>

    ...
    <>
      ...
      <section className="py-20 md:py-28" style={{ backgroundColor: "#0a0a0a" }}>
        <div className="max-w-4xl mx-auto px-6">
          <div ref={rHistory.ref} className={rc(rHistory.visible)}>
            <h2
              className="text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight text-white mb-10 text-center"
            >
      ...
      <section className="py-20 md:py-28" style={{ backgroundColor: "#f97316" }}>
        ...
        >
          ...
          <p className="text-sm md:text-base text-white/80 max-w-2xl mx-auto mb-10">
            Und wir können endlich die Intransparenz auflösen die uns alle — Profis, Besitzer, Pferde — jeden Tag unnötig kostet.
          </p>
          <button
            onClick={scrollToWaitlist}
            className="inline-flex items-center gap-2 h-14 px-10 rounded-full text-lg font-bold transition-all duration-200 hover:scale-[1.03] hover:shadow-lg"
            style={{
          ...
          >
            Ich will Teil dieser Bewegung sein →
          </button>
        </div>
      </section>
    </>

...
const TABS: AudienceTab[] = [
  ...
  },
  {
    ...
    icon: "🤝",
    label: "Fachpartner",
    headline: "Rund ums Pferd vernetzt",
    subline: "Für Tierärzte, Physiotherapeuten, Osteopathen, Trainer und alle Pferde-Profis",
    features: [
      "Pferdeakten der freigegebenen Pferde einsehen",
      "Eigene Befunde dokumentieren",
      "Behandlungspläne erstellen",
      "Rechnungen stellen",
      "Mit Hufpfleger und Besitzer kommunizieren",
      "Fachrichtungs-spezifische Vorlagen",
      "Im HM-Netzwerk gefunden werden",
    ],
    price: "Basisversion kostenlos",

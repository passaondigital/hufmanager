...
export const WhatsAppButton = ({ phoneNumber, providerName }: Props) => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-fab bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg transition-all hover:scale-110 hidden md:flex"

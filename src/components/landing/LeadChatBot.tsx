...
export function LeadChatBot({ providerId, providerName, providerLogo, primaryColor }: LeadChatBotProps) {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-20 right-6 z-fab">
        {/* Speech Bubble */}
        {showBubble && !isOpen && (
          <div 
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-36 right-6 z-fab w-[340px] max-w-[calc(100vw-48px)] bg-background border border-border rounded-2xl shadow-2xl overflow-hidden animate-scale-in">
          {/* Header */}
          <div 

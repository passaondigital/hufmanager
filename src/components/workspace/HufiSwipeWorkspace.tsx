...
import { useWorkspaceSwipe } from "@/hooks/workspace/useWorkspaceSwipe";
...
export function HufiSwipeWorkspacePreview() {
  ...
  return <section aria-label="Hufi Workspace Vorschau" className="fixed inset-y-0 left-0 z-50 pointer-events-none" {...gesture}>

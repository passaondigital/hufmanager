...
export function AIChatWidget() {
  ...
  if (!isOpen) {
    return (
      <Button
        ...
        className="hidden md:inline-flex fixed bottom-6 right-6 h-14 w-14 rounded-full shadow-lg bg-primary hover:bg-primary/90 z-fab"
        size="icon"
      >
  ...
  return (
    <div className="fixed bottom-24 md:bottom-6 right-4 md:right-6 w-[calc(100vw-2rem)] md:w-96 h-[70vh] md:h-[500px] bg-background border rounded-lg shadow-2xl flex flex-col z-fab">
      {/* Header */}

...
import { Calendar, Clock, CheckCircle2, Circle, XCircle, Paperclip, Image, ChevronRight } from "lucide-react";
                  ...
                  {sortedAppointments.map((apt) => {
                    ...
                    return (
                      ...
                      >
                        {/* Timeline dot */}
                        <div className={cn(
                          "relative z-10 w-8 h-8 rounded-full flex items-center justify-center shrink-0 transition-transform group-hover:scale-110",

...
const providerSteps: Record<string, { quick: TourStep[]; detailed: TourStep[] }> = {
  termine: {
    quick: [
      ...
      { target: '[data-tour="due-appointments"]', title: 'Fällige Pferde', description: 'Hufi erinnert dich automatisch, wenn ein Pferd wieder dran ist. Kein Termin geht verloren.', position: 'bottom' },
      { target: '[data-tour="checklist"]', title: 'Tour planen', description: 'Unter „Touren" planst du deine Tagesroute. Hufi optimiert die Reihenfolge für minimale Fahrtzeit.', position: 'bottom' },
    ...
    detailed: [
      ...
      { target: '[data-tour="due-appointments"]', title: 'Fällige Termine', description: 'Hufi berechnet automatisch, wann jedes Pferd wieder dran ist. Du siehst hier alle überfälligen und bald fälligen Pferde.', position: 'bottom' },
      { target: '[data-tour="checklist"]', title: 'Erste Schritte', description: 'Arbeite diese Punkte ab und dein Hufi ist vollständig eingerichtet. Jeder Haken bringt dich näher zum perfekten Workflow.', position: 'bottom' },
      ...
      { target: '[data-tour="stats-grid"]', title: 'Tour-Manager', description: 'Im Bereich „Touren" planst du deine Tagesroute mit Karte. Hufi optimiert die Reihenfolge und zeigt dir die Navigation.', position: 'bottom' },
      ...
      { target: '[data-tour="stats-grid"]', title: 'Erinnerungen', description: 'Hufi sendet automatisch Terminerinnerungen an deine Kunden — per Push-Benachrichtigung oder E-Mail.', position: 'bottom' },
      { target: '[data-tour="stats-grid"]', title: 'Wiederkehrende Termine', description: 'Erstelle Serien-Termine für regelmäßige Bearbeitungsintervalle. Hufi plant automatisch den nächsten Termin.', position: 'bottom' },
  ...
  pferdeakte: {
    ...
    detailed: [
      ...
      { target: '[data-tour="stats-grid"]', title: 'Preisgruppen', description: 'Hinterlege pferdespezifische Preise oder nutze deine Standardpreisliste. Hufi rechnet automatisch korrekt ab.', position: 'bottom' },
  ...
  rechnungen: {
    quick: [
      ...
      { target: '[data-tour="stats-grid"]', title: 'Zahlungsstatus', description: 'Behalte den Überblick: Offen, bezahlt, überfällig. Hufi erinnert automatisch bei offenen Rechnungen.', position: 'bottom' },
    ...
    detailed: [
      ...
      { target: '[data-tour="stats-grid"]', title: 'Steuer & MwSt.', description: 'Kleinunternehmerregelung oder MwSt.-pflichtig — Hufi rechnet korrekt ab und zeigt die Steuer separat aus.', position: 'bottom' },
  ...
  kunden: {
    ...
    detailed: [
      ...
      { target: '[data-tour="stats-grid"]', title: 'Automatische Erinnerungen', description: 'Hufi erinnert Kunden automatisch an fällige Termine — du musst nichts tun.', position: 'bottom' },
  ...
  vernetzung: {
    quick: [
      { target: '[data-tour="stats-grid"]', title: 'Das Netzwerk', description: 'Hufi verbindet Hufbearbeiter, Pferdebesitzer, Tierärzte und Physiotherapeuten in einem System.', position: 'bottom' },
    ...
    detailed: [
      { target: '[data-tour="stats-grid"]', title: 'Das Ökosystem', description: 'Hufi ist mehr als eine App — es ist ein Netzwerk für alle, die mit Pferden arbeiten.', position: 'bottom' },
      ...
      { target: '[data-tour="stats-grid"]', title: 'Fachpartner einladen', description: 'Empfiehl einem Tierarzt, sich bei Hufi zu registrieren. Er kann dann auf freigegebene Akten zugreifen.', position: 'bottom' },
...
const clientSteps: Record<string, { quick: TourStep[]; detailed: TourStep[] }> = {
  ...
  termine: {
    quick: [
      ...
      { target: '[data-tour="client-appointments"]', title: 'Erinnerungen', description: 'Hufi erinnert dich rechtzeitig an anstehende Termine per Push-Nachricht.', position: 'bottom' },
  ...
  vernetzung: {
    ...
    detailed: [
      { target: '#pferde-section', title: 'Das Netzwerk', description: 'Hufi verbindet alle Menschen, die sich um dein Pferd kümmern, in einem digitalen Ökosystem.', position: 'bottom' },
...
const partnerSteps: Record<string, { quick: TourStep[]; detailed: TourStep[] }> = {
  ...
  vernetzung: {
    ...
    detailed: [
      { target: '[data-tour="partner-kpi"]', title: 'Das Ökosystem', description: 'Hufi verbindet alle Fachleute rund ums Pferd in einem digitalen Netzwerk.', position: 'bottom' },
...
const employeeSteps: Record<string, { quick: TourStep[]; detailed: TourStep[] }> = {
  ...
  dokumentation: {
    ...
    detailed: [
      ...
      { target: '[data-tour="employee-assignments"]', title: 'Bearbeitung durchführen', description: 'Während du arbeitest, erfasst Hufi automatisch deine Arbeitszeit.', position: 'bottom' },
  ...
  zeit: {
    ...
    detailed: [
      { target: '[data-tour="employee-kpi"]', title: 'Zeiterfassung', description: 'Hufi erfasst deine Arbeitszeit automatisch beim Check-in und Check-out.', position: 'bottom' },
  ...
  vernetzung: {
    ...
    detailed: [
      { target: '[data-tour="employee-kpi"]', title: 'Teamarbeit', description: 'Hufi verbindet dich mit deinem Chef, den Kunden und dem ganzen Netzwerk.', position: 'bottom' },
...
export const ctaStep: TourStep = {
  ...
  description: 'Du hast gesehen, wie Hufi funktioniert. Erstelle jetzt deinen eigenen Account und digitalisiere deinen Betrieb — kostenlos testen!',
  position: 'bottom',
};

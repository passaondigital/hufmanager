      ...
      items: [
        {
          ...
          children: [
            ...
            { label: "Geschäft", path: "/partner-management?tab=business" },
            { label: "Abo & Module", path: "/partner-management?tab=subscription" },
            { label: "Zeiten", path: "/partner-management?tab=hours" },
            { label: "Erinnerungen", path: "/partner-management?tab=reminders" },
            { label: "Landing", path: "/partner-management?tab=landing" },
            { label: "Bewertungen", path: "/partner-management?tab=reviews" },
            { label: "Rechtliches", path: "/partner-management?tab=legal" },
            { label: "Zahlung", path: "/partner-management?tab=payment" },
            { label: "App", path: "/partner-management?tab=app" },

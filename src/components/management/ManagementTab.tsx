          ...
          {isCopecart && invoices.length === 0 ? (
            <Alert className="border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950/30">
              ...
              <AlertDescription className="text-blue-800 dark:text-blue-300">
                ...
                <br />
                Fragen zur Abrechnung? → <a href="mailto:kontakt@hufiapp.de" className="underline font-medium">kontakt@hufiapp.de</a>
              </AlertDescription>
            </Alert>
          ) : invoices.length === 0 ? (
          ...
          {contract ? (
            ...
            <Alert>
              ...
              <AlertDescription>
                ...
                Bei Fragen: <a href="mailto:kontakt@hufiapp.de" className="underline font-medium">kontakt@hufiapp.de</a>
              </AlertDescription>
            </Alert>
          )}
        </CardContent>

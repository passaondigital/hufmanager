...
export const WIDGET_DEFINITIONS: WidgetDefinition[] = [
  ...
  { type: "wetter", label: "Wetter", icon: "🌤️", defaultWidth: 1, defaultHeight: 1, roles: ["provider", "partner", "employee", "client"], category: "Sonstiges" },
  { type: "notizen", label: "Notizen", icon: "📝", defaultWidth: 1, defaultHeight: 1, roles: ["provider", "partner", "employee", "client"], category: "Sonstiges" },
  { type: "zitat_des_tages", label: "Zitat des Tages", icon: "💬", defaultWidth: 1, defaultHeight: 1, roles: ["provider", "partner", "employee", "client"], category: "Sonstiges" },

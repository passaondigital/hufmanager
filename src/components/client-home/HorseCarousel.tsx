...
export function HorseCarousel({ horses, onAddHorse }: HorseCarouselProps) {
  ...
  return (
    <div className="px-4">
      ...
      <div className="hm-h-scroll" role="list">
        {horses.map((horse) => {
          ...
          return (
            <div
              ...
              className="min-w-[140px] flex-shrink-0 rounded-xl p-4 text-center cursor-pointer transition-all hover:-translate-y-0.5 hover:shadow-lg"
              style={{
            ...
            >
              <div
                className="w-[52px] h-[52px] rounded-full mx-auto mb-2 overflow-hidden border-2 flex items-center justify-center hm-avatar-pulse"
                style={{
              ...
              <p className="text-[14px] font-medium truncate" style={{ color: "var(--hm-text)" }}>
                {horse.name}
              </p>
              <p className="text-[11px] mt-0.5 truncate" style={{ color: "var(--hm-text3)" }}>
                {[horse.breed, age ? `${age} J.` : null].filter(Boolean).join(" · ") || "–"}
              </p>
              <span
                className="inline-flex items-center gap-1 mt-2 px-2 py-0.5 rounded-[20px] text-[10px] font-medium"
                style={{
        ...
        <div
          role="listitem"
          onClick={onAddHorse}
          className="min-w-[140px] flex-shrink-0 rounded-xl p-4 flex flex-col items-center justify-center cursor-pointer transition-all"
          style={{
